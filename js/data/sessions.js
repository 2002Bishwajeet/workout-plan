...
// the number, so a weightKey on a BW/0 weight would render "— kg"). Pull-up,
// Dip (Block 1), pike push-ups and hanging leg raises stay bodyweight; the dip
...
const B1_PULL = { id: 'pull-1', day: 'Day 02 · Tue', title: 'Pull', focus: 'Deadlift primary · vertical + horizontal volume', rpe: '7 — 8',
  exercises: [
    ...
    { name: 'Chest Supported Row',   sets: 3, reps: '8-10',    weightKey: 'cs_row',     rpe: '7-8' },
...
const B1_LEGS = { id: 'legs-1', day: 'Day 03 · Thu', title: 'Legs', focus: 'Quad + posterior volume · calf + core', rpe: '7 — 8',
  exercises: [
    ...
    { name: 'Standing Calf Raise',   sets: 4, reps: '10-12',   weightKey: 'calf',       rpe: '8' },
...
const B1_UPPER = { id: 'upper-1', day: 'Day 04 · Sat', title: 'Upper +', focus: 'Bench top-set + back-offs · dip + pull-up volume', rpe: '8',
  exercises: [
    ...
    { name: 'Pull-up',               sets: 4, reps: 'AMRAP-1', weight: 'BW',                 rpe: '8' },
    { name: 'Incline DB Curl',       sets: 3, reps: '10-12',   weightKey: 'incline_db_curl', rpe: '7' },
    { name: 'Overhead Tricep Ext',   sets: 3, reps: '10-12',   weightKey: 'oh_tri',          rpe: '7' },
    { name: 'Cable Crunch',          sets: 3, reps: '12-15',   weightKey: 'cable_crunch',    rpe: '8' }
  ]};
...
const B2_PULL = { id: 'pull-1', day: 'Day 02 · Tue', title: 'Pull', focus: 'Heavy deadlift · pull-up density · row volume', rpe: '8 — 8.5',
  exercises: [
    ...
    { name: 'Chest Supported Row',   sets: 4, reps: '6-8',     weightKey: 'cs_row',     rpe: '8' },
...
const B2_UPPER = { id: 'upper-1', day: 'Day 04 · Sat', title: 'Upper +', focus: 'Bench intensity · weighted dip primary · pull volume', rpe: '8 — 8.5',
  exercises: [
    ...
    { name: 'Incline DB Curl',       sets: 3, reps: '8-10',    weightKey: 'incline_db_curl', rpe: '8' },
    { name: 'Overhead Tricep Ext',   sets: 3, reps: '10-12',   weightKey: 'oh_tri',          rpe: '7' },
    { name: 'Cable Crunch',          sets: 3, reps: '12-15',   weightKey: 'cable_crunch',    rpe: '8' }
  ]};
...
const B3_PULL = { id: 'pull-1', day: 'Day 02 · Tue', title: 'Pull', focus: 'Heavy deadlift triples · pull-up test · back strength', rpe: '8.5 — 9',
  exercises: [
    ...
    { name: 'Chest Supported Row',   sets: 3, reps: '6-8',     weightKey: 'cs_row',     rpe: '8.5' },
...
const B3_UPPER = { id: 'upper-1', day: 'Day 04 · Sat', title: 'Upper +', focus: 'Bench peak · weighted dip · calisthenic tests', rpe: '8.5 — 9',
  exercises: [
    ...
    { name: 'Pull-up',               sets: 4, reps: 'AMRAP-1', weight: 'BW',                 rpe: '9' },
    { name: 'Incline DB Curl',       sets: 3, reps: '8-10',    weightKey: 'incline_db_curl', rpe: '8' },
    { name: 'Overhead Tricep Ext',   sets: 3, reps: '10-12',   weightKey: 'oh_tri',          rpe: '8' },
    { name: 'Cable Crunch',          sets: 3, reps: '12-15',   weightKey: 'cable_crunch',    rpe: '8.5' }
  ]};
...
const B4_PULL = { id: 'pull-1', day: 'Day 02 · Tue', title: 'Pull', focus: 'Deload · light pulls · movement quality', rpe: '6 — 7',
  exercises: [
    ...
    { name: 'Chest Supported Row',   sets: 2, reps: '10',      weightKey: 'cs_row',     rpe: '6' },
    { name: 'Lat Pulldown (neutral)',sets: 2, reps: '12',      weightKey: 'pulldown',   rpe: '6' },
    { name: 'Face Pull',             sets: 2, reps: '15',      weightKey: 'face_pull',  rpe: '6' }
  ]};
...
const B4_UPPER = { id: 'upper-1', day: 'Day 04 · Sat', title: 'Upper +', focus: 'Deload · light upper · prep next cycle', rpe: '6 — 7',
  exercises: [
    ...
    { name: 'Incline DB Curl',       sets: 2, reps: '12',      weightKey: 'incline_db_curl', rpe: '6' },
    { name: 'Cable Crunch',          sets: 2, reps: '12',      weightKey: 'cable_crunch',    rpe: '6' }
  ]};
